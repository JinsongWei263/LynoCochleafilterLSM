...
void emxInitStruct_struct1_T(struct1_T *pStruct)
{
  ...
  emxInit_boolean_T(&pStruct->e, 2);
  emxInit_real_T(&pStruct->d, 2);
  emxInit_real_T(&pStruct->C, 2);
  emxInit_real_T(&pStruct->Win, 2);
  emxInit_real_T(&pStruct->ckk, 2);
}
...
/* End of code generation (LSM_emxutil.cpp) */
